...
class Game:
    def __init__(self):
        ...
        try:
            with open(join('assests' ,'Data', 'highsore.txt')) as score_file:
    ...
    def load_dungeon(self):
        dungeon_map = load_pygame(join('assests' ,'Data', 'Dungeon map','Dungeon Tiles', 'Dungeon_map.tmx'))
    ...
    def load_forest(self):
        ...
        map = load_pygame(join('assests' ,'Data' , 'Forest map' , 'Forest map.tmx'))
    ...
    def title_screen(self):
        titel_screen_display_image = pygame.image.load(join('assests' ,'Data' , 'title screen' , 'new title.png'))
    ...
    def game_story(self):
        bg_imgae = pygame.image.load(join('assests' ,'images' , 'Backgrounds' , 'scroll.jpg'))
